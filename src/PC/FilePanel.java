   ...
   {  
	  ...
	  switch (frameNum)
	  {
	  	case 1:
	  		 ...
	  		 server = new Server2(receivedStrings,AndroidIP);
...
//	    	JFileChooser c = new JFileChooser("C:\\Users\\Will\\Desktop\\Encrypted Files\\");
	        ...
	        try {
				...
				fos.write(("File split Time Stamp : " + ge.splitTime + "\r\n").getBytes());
	        ...
	        //System.out.println("Piece transmit end time stamp : " + System.currentTimeMillis());
	        try {
	        ...
	        try {
				fos.write(("Index encrypt End Time Stamp : " + (System.currentTimeMillis()-startTime )+ "\r\n").getBytes());
				JOptionPane.showMessageDialog(frame, "Index enctyption Finished");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	        ...
	        try {
				fos.write(("Index split End Time Stamp : " + (System.currentTimeMillis()-startTime )+ "\r\n").getBytes());
				JOptionPane.showMessageDialog(frame, "Index Splitting Finished");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
